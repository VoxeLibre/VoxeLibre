...
* `hbhunger_icon.png`—PilzAdam, modified by BlockMen
* `hbhunger_bgicon.png`—PilzAdam, modified by BlockMen
* `hbhunger_bar.png—Wuzzy`
...
* `mcl_hunger_bite.1.ogg`, `mcl_hungr_bite.2.ogg`
* `survival_thirst_drink.ogg`
