...
local function register_dimension_biomes()
	...
	mcl_mapgen_core.register_decoration({
		...
		y_max = underworld_bounds.max + 15,
		height = 6,
		max_height = 10,
	...
	mcl_mapgen_core.register_decoration({
		...
		sidelen = 16,
		fill_ratio = 10,
		y_min = underworld_bounds.min - 10,
		y_max = lava_sea_level,
		height = 7,
		max_height = 14,
		decoration = "mcl_nether:netherrack",
	...
	minetest.register_biome({
		...
		y_max = underworld_bounds.max + 80,
		heat_point = 100,
		humidity_point = 0,
		_mcl_biome_type = "hot",
		_mcl_grass_palette_index = 17,
	...
	mcl_mapgen_core.register_decoration({
		...
		biomes = {"Nether"},
		y_min = lava_sea_level,
		y_max = underworld_bounds.max - 11,
		decoration = "mcl_nether:netherrack",
		flags = "all_floors",
		param2 = 0,
	})
	...
	minetest.register_biome({
		...
		humidity_point = 500,
		vertical_blend = 16,
		max_pos = vector.new(1250, fringe_bounds.min + 512, 1250),
		min_pos = vector.new(-1250, fringe_bounds.min, -1250),
		_mcl_biome_type = "medium",
		_mcl_grass_palette_index = 0,
		_mcl_foliage_palette_index = 0,
		_mcl_water_palette_index = 0,
	...
	minetest.register_biome({
		...
		node_river_water = "air",
		node_cave_liquid = "air",
		max_pos = vector.new(650, fringe_bounds.min + 512, 650),
		min_pos = vector.new(-650, fringe_bounds.min, -650),
		heat_point = 50,
		humidity_point = 50,
		vertical_blend = 16,
		_mcl_biome_type = "medium",
...
local function register_biome_ores()
	...
	local monster_egg_scarcity = 26 * 26 * 26
	minetest.register_ore({
		ore_type = "scatter",
...
local function register_dimension_ores()
	...
	minetest.register_ore({
		...
		clust_size = 1,
		biomes = lava_biomes,
		y_min = lava_sea_level + 2,
		y_max = lava_sea_level + 12,
	})
	...
	minetest.register_ore({
		...
		clust_size = 1,
		biomes = lava_biomes,
		y_min = lava_sea_level + 13,
		y_max = lava_sea_level + 48,
	})
	minetest.register_ore({
		ore_type = "scatter",
		ore = "mcl_nether:nether_lava_source",
	...
	minetest.register_ore({
		...
		y_min = island_level,
		y_max = island_level + 16,
		clust_num_ores = 3375,
		clust_size = 15,

		noise_params = {
			offset = island_level + 6,
			scale = -1,
...
local function register_decorations()
	...
	mcl_mapgen_core.register_decoration({
		...
		flags = "force_placement",
		y_min = overworld_lava_ceiling + 5,
		y_max = -20,
	})
...
local function register_dimension_decorations()
	...
	mcl_mapgen_core.register_decoration({
		...
		biomes = {"WarpedForest"},
		y_min = lava_sea_level + 1,
		y_max = underworld_bounds.max - 10,
		flags = "all_floors",
	...
	mcl_mapgen_core.register_decoration({
		...
		biomes = {"WarpedForest"},
		y_min = lava_sea_level + 1,
		y_max = underworld_bounds.max - 14,
		flags = "all_floors, place_center_x, place_center_z",
	...
	mcl_mapgen_core.register_decoration({
		...
		biomes = {"BasaltDelta"},
		y_min = lava_sea_level + 1,
		y_max = underworld_bounds.max - 61,
	...
	mcl_mapgen_core.register_decoration({
		...
		biomes = {"BasaltDelta"},
		y_min = lava_sea_level + 1,
		y_max = underworld_bounds.max - 26,
		flags = "all_floors, all ceilings",
	})
	mcl_mapgen_core.register_decoration({
		deco_type = "simple",
