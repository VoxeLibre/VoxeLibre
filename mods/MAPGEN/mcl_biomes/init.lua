...
local function register_dimension_biomes()
	...
	mcl_mapgen_core.register_decoration({
		...
		y_max = underworld.start + underworld.height + 15,
		height = 6,
		max_height = 10,
	...
	minetest.register_biome({
		...
		y_max = underworld.start + underworld.height + 80,
		heat_point = 100,
		humidity_point = 0,
		_mcl_biome_type = "hot",
		_mcl_grass_palette_index = 17,
	...
	minetest.register_biome({
		...
		node_cave_liquid = "air",
		y_min = fringe.start,
		y_max = fringe.start + fringe.height + 80,
	...
	minetest.register_biome({
		...
		humidity_point = 500,
		vertical_blend = 16,
		max_pos = vector.new(1250, fringe.start + 512, 1250),
		min_pos = vector.new(-1250, fringe.start, -1250),
		_mcl_biome_type = "medium",
		_mcl_grass_palette_index = 0,
		_mcl_foliage_palette_index = 0,
		_mcl_water_palette_index = 0,
	...
	minetest.register_biome({
		...
		node_river_water = "air",
		node_cave_liquid = "air",
		max_pos = vector.new(650, fringe.start + 512, 650),
		min_pos = vector.new(-650, fringe.start, -650),
		heat_point = 50,
		humidity_point = 50,
		vertical_blend = 16,
		_mcl_biome_type = "medium",
...
local function register_dimension_ores()
	...
	minetest.register_ore({
		...
		y_max = underworld.start + underworld.height - 13,
		noise_threshold = 0.0,
		noise_params = {
			offset = 0.5,
			scale = 0.1,
	...
	minetest.register_ore({
		...
		y_min = fringe.start + 64,
		y_max = fringe.start + 80,
		clust_num_ores = 3375,
		clust_size = 15,

		noise_params = {
			offset = fringe.start + 70,
			scale = -1,
...
local function register_dimension_decorations()
	...
	mcl_mapgen_core.register_decoration({
		...
		y_max = underworld.start + underworld.height - 1,
		flags = "all_floors",
	...
	mcl_mapgen_core.register_decoration({
		...
		biomes = {"WarpedForest"},
		y_min = mcl_vars.mg_lava_nether_max + 1,
		y_max = underworld.start + underworld.height - 10,
		flags = "all_floors",
	...
	mcl_mapgen_core.register_decoration({
		...
		biomes = {"WarpedForest"},
		y_min = mcl_vars.mg_lava_nether_max + 1,
		y_max = underworld.start + underworld.height - 14,
		flags = "all_floors, place_center_x, place_center_z",
	...
	mcl_mapgen_core.register_decoration({
		...
		place_offset_y = -1,
		y_min = mcl_vars.mg_lava_nether_max + 1,
		y_max = underworld.start + underworld.height - 5,
		flags = "all_floors, force_placement",
	})
