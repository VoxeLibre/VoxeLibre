...
local overworld = dofile(modpath..DIR_DELIM.."overworld.lua")
local underworld = dofile(modpath..DIR_DELIM.."underworld.lua")
local fringe = dofile(modpath..DIR_DELIM.."fringe.lua")
...
local function register_biomes()
	...
	* Desert M
	...
	local overworld_biomes = overworld.biomes
	overworld.register_biomes()
