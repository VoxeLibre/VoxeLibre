...
minetest.register_node("mcl_core:stone_with_iron", {
	...
	is_ground_content = true,
	stack_max = 64,
	groups = {pickaxey=3, building_block=1, material_stone=1, xp=3, blast_furnace_smeltable=1},
...
minetest.register_node("mcl_core:stone_with_emerald", {
	...
	is_ground_content = true,
	stack_max = 64,
	groups = {pickaxey=4, building_block=1, material_stone=1, xp=10, blast_furnace_smeltable=1},
...
minetest.register_node("mcl_core:brick_block", {
	...
	is_ground_content = false,
	stack_max = 64,
	groups = {pickaxey=1, building_block=1, material_stone=1, banner_pattern=1},
	sounds = mcl_sounds.node_sound_stone_defaults(),
	_mcl_blast_resistance = 6,
	_mcl_hardness = 2,
})
