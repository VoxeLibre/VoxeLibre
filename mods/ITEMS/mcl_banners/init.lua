...
local colors = {
	...
	["unicolor_darkcolor"] = {"grey",       "Grey Banner",       "mcl_wool:grey", "#303030E0" },
	["unicolor_grey"] = {"silver",     "Light Grey Banner", "mcl_wool:silver", "#5B5B5BE0" },
	["unicolor_black"] = {"black",      "Black Banner",      "mcl_wool:black", "#000000E0" },
	["unicolor_red"] = {"red",        "Red Banner",        "mcl_wool:red", "#CC0000E0" },
	["unicolor_yellow"] = {"yellow",     "Yellow Banner",     "mcl_wool:yellow", "#CCB800E0" },
	["unicolor_dark_green"] = {"green",      "Green Banner",      "mcl_wool:green", "#008000E0" },
	["unicolor_cyan"] = {"cyan",       "Cyan Banner",       "mcl_wool:cyan", "#00CCCCE0" },
	["unicolor_blue"] = {"blue",       "Blue Banner",       "mcl_wool:blue", "#0000CCE0" },
	["unicolor_red_violet"] = {"magenta",    "Magenta Banner",    "mcl_wool:magenta", "#CC009CE0" },
	["unicolor_orange"] = {"orange",     "Orange Banner",     "mcl_wool:orange", "#CC5000E0" },
	["unicolor_violet"] = {"purple",     "Purple Banner",     "mcl_wool:purple", "#5000CCE0" },
	["unicolor_brown"] = {"brown",      "Brown Banner",      "mcl_wool:brown", "#7A3C00E0" },
	["unicolor_pink"] = {"pink",       "Pink Banner",       "mcl_wool:pink", "#EE658CE0" },
	["unicolor_lime"] = {"lime",       "Lime Banner",       "mcl_wool:lime", "#50CC00E0"},
	["unicolor_light_blue"] = {"light_blue", "Light Blue Banner", "mcl_wool:light_blue", "#5050FFE0" },
}
