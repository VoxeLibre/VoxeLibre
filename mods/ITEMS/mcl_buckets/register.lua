...
if mod_mcl_core then
	-- Lava bucket
	mcl_buckets.register_liquid("mcl_buckets:bucket_lava", {
	...
	-- Water bucket
	mcl_buckets.register_liquid("mcl_buckets:bucket_water", {
...
if mod_mclx_core then
	-- River water bucket
	mcl_buckets.register_liquid("mcl_buckets:bucket_river_water", {
