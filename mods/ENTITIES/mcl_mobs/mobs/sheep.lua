...
local colors = {
	...
	unicolor_light_blue = { mobs_mc.items.wool_light_blue, "#5050FFD0" },
}

local sheep_texture_raw(color)
	return {
...
local sheep_texture = function(color_group)
	...
	return sheep_texture_raw(colors[color_group][2])
end
...
mobs:register_mob("mobs_mc:sheep", {
	...
	get_rainbow_textures = function(color)
		sheep_texture_raw(color .. "D0")
	end,
