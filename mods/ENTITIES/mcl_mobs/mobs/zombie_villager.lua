...
mobs:register_mob("mobs_mc:villager_zombie", {
	...
	textures = {
		{"empty.png", "mobs_mc_zombie_butcher.png", "empty.png"},
		{"empty.png", "mobs_mc_zombie_farmer.png", "empty.png"},
		{"empty.png", "mobs_mc_zombie_librarian.png", "empty.png"},
		{"empty.png", "mobs_mc_zombie_priest.png", "empty.png"},
		{"empty.png", "mobs_mc_zombie_smith.png", "empty.png"},
		{"empty.png", "mobs_mc_zombie_villager.png", "empty.png"},
	},
