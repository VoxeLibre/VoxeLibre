...
- `mcl_util.djb_hash(str)` is a simple string hashing function attributed to DJ Bernstein.
...
- `mcl_util.hash_pos(x, y, z, seed)` is a simple hash function of a coordinate vector,
  ...
  In contrast to the misnamed Luanti `core.hash_node_position`, this is a *mixing* function.
